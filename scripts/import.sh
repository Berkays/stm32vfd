...
mkdir $CUR_DIR/CubeMx
mkdir $CUR_DIR/CubeMx/$BOARD
mkdir $CUR_DIR/src/$BOARD
...
python3 $SCRIPT_DIR/import.py $BOARD_FAMILY

cp -rv ./STM32F103C6Tx_FLASH.ld $CUR_DIR/CubeMx/$BOARD/${BOARD}TX_FLASH.ld
